...
import EmployeeForm from './EmployeeForm'; // Asegúrate de importar el formulario de creación de empleados
...
const EmployeeList = () => {
  ...
  const [isModalOpenEmployee, setIsModalOpenEmployee] = useState(false); // Estado para manejar el modal
      ...
      {isModalOpenEmployee && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center">
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
            ...
            <EmployeeForm onClose={closeModal} onEmployeeCreated={handleEmployeeCreated} />
            <button
              onClick={closeModal}
